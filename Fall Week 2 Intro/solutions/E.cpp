...
/* Solution: 
 * It is always possible! Let's apply operation 2 to all the squares in the grid.
 * Most likely, some squares will be black and some will be white. If a square is black,
 * let's replace the operation at this square with operation 3. This keeps all other squares
 * the same! So we've only turned this square into a white square. Repeating this for all 
 * squares lets us make sure that all squares are white.
 */
